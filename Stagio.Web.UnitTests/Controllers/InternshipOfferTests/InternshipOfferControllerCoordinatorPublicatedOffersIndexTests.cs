...
{
    [TestClass]
    public class InternshipOfferControllerCoordinatorPublicatedOffersIndexTests : InternshipOfferControllerBaseClassTests
    {
        [TestMethod]
        public void publicated_offers_index_should_return_view_with_internship_offers()
        {
            ...
            var offers = initializeOffers();

            // Action
            var result = _internshipOfferController.CoordinatorPublicatedOffersIndex() as ViewResult;
        ...
        private List<InternshipOffer> initializeOffers()
        {
